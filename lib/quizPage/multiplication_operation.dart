...
class MultiplicationOperation extends StatefulWidget {
  const MultiplicationOperation({ Key? key }) : super(key: key);

  @override
  State <MultiplicationOperation> createState() => _MultiplicationOperationState();
}

class _MultiplicationOperationState extends State<MultiplicationOperation> {
                      ...
                      if (!_clicked) {
                        setState(() {
                          if (isAnswerCorrect(_clicked, index)) {
                            ...
                            TempData.mulScore = TempData.mulScore! + 1;
