...
class MixOperation extends StatefulWidget {
  const MixOperation({ Key? key }) : super(key: key);

  @override
  State <MixOperation> createState() => _MixOperationState();
}

class _MixOperationState extends State<MixOperation> {
                  ...
                  child: InkWell(
                      ...
                      if (!_clicked) {
                        setState(() {
                          if (isAnswerCorrect(_clicked, index)) {
                            ...
                            TempData.mixScore = TempData.mixScore! + 1;
                    ...
                    child: AnimatedSwitcher(
                      ...
                      child: AnswerButton(
                        key: _key[index],
                        bg: _answerBg[index],
                        answer: isDivisionOperation() ? questionAnswer.first.toInt() % questionAnswer.second.toInt() == 0 ? questionAnswer.divisionAnswerList.elementAt(questionAnswer.chooseAnswer.elementAt(index)).toStringAsFixed(0) : questionAnswer.divisionAnswerList.elementAt(questionAnswer.chooseAnswer.elementAt(index)).toStringAsFixed(2) : questionAnswer.answerList.elementAt(questionAnswer.chooseAnswer.elementAt(index)).toString(),
