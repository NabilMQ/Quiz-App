...
class SubstractionOperation extends StatefulWidget {
  const SubstractionOperation({ Key? key }) : super(key: key);

  @override
  State <SubstractionOperation> createState() => _SubstractionOperationState();
}

class _SubstractionOperationState extends State<SubstractionOperation> {
